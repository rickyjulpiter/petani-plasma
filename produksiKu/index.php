      ...
      if (!selectedOptionKebun) {
        $("#jsGrid1").jsGrid({
          ...
          fields: [{
            ...
            {
              name: "tangkai_panjang",
              title: "Tangkai Panjang",
              type: "number",
              width: 55
            },
            {
              name: "tidak_cangkam_kodok",
              title: "Tdk Cangkam Kodok",
              type: "number",
              width: 55
            },
            {
              name: "kg_brondolan_diatas_goni",
              title: "Kg Brondolan Diatas Goni",
              type: "number",
              width: 55
            },
            {
              name: "kg_brondolan_tanpa_goni",
              title: "Kg Brondolan Tanpa Goni",
              type: "number",
              width: 55
            },
            {
