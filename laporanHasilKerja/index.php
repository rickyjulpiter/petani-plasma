...
<body class="hold-transition sidebar-mini">
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  <label>Staff</label>
                  <label for="staffSelect"></label><select class="form-control select2bs4" id="staffSelect" style="width: 100%;" data-placeholder="Staff">
  ...
  <script type="text/javascript">
      ...
      if (!selectedOptionKebun) {
        $("#jsGrid1").jsGrid({
          ...
          fields: [{
            ...
            {
              name: "kondisi",
              title: "Kondisi Kapling saat kunjungan",
              type: "text",
              width: 170
            },
            {
        ...
        $("#jsGrid1").jsGrid({
          ...
          fields: [{
            ...
            },
            {
              ...
              deleteButton: false,
              itemTemplate: function(value, item) {
                return '<button class = "btn btn-block btn-primary btn-sm" onclick = "goToLaporanKerjaDetail(\'' + item['keys'] + '\')" href="../laporanHasilKerja/detail.php">Detail</button>';
              }
            }
          ]
        });
    ...
    function goToLaporanKerjaDetail(id) {
      console.log(id)
      localStorage.setItem("report_id", id);
      window.location.href = "../laporanHasilKerja/detail.php";
    }
  </script>
</body>
